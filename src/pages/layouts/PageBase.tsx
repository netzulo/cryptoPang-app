...
const teams = [
  ...
  { id: 2, name: '0x1234...5678', href: '#', initial: '#02', current: false },
  { id: 3, name: '0x1234...5678', href: '#', initial: '#03', current: false },
]
                            ...
                            >
                              <span
                                className={classNames(
                                  ...
                                  'size-6 flex shrink-0 items-center justify-center rounded-lg border bg-white text-[0.625rem] font-medium',
                                )}
                              >
                                {team.initial}
                              </span>
